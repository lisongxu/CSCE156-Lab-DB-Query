...
1. Download the provided MySQL file [`albumsDB.sql`](https://github.com/lisongxu/CSCE156-Lab-DB-Query/albumsDB.sql), which creates multiple tables about music albums, songs, and the artists involved. Below is the entity-relation diagram of these tables. 
