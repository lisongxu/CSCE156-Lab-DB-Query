...
1. Download the provided MySQL file [`albumDB.sql`](https://github.com/lisongxu/CSCE156-Lab-DB-Query/albumDB.sql), which creates multiple tables about music albums, songs, and the artists involved. Below is the entity-relation diagram of these tables. 
