...
1. Download the provided MySQL file [`albumQueries.sql`](albumQueries.sql), which creates multiple tables about music albums, songs, and the artists involved. Below is the entity-relation diagram of these tables. 
